      ...
      * modification.
       01 S-ECR-AFG.
           ...
           05 LINE 22 COLUMN 30 VALUE "1 - Oui  2 - Non  0 - Retour ".
           05 LINE 23 COLUMN 41 PIC X(01) TO WS-CHX-ADM.
      ...
      ******************************************************************
       0100-MAJ-CLI-DEB.
           MOVE "1" TO WS-CHX-ADM
           PERFORM UNTIL WS-CHX-ADM EQUAL 0
